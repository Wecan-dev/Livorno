...
<section id="contactanos" class="seccion-form-banner section">
	<div class="content-form form-banner" id="contacto">
		...
		<div class="form__item ">
			<form style="width: 100%;" method="POST" action="https://nivel.activehosted.com/proc.php" id="_form_13_" class="_form _form_13 _inline-form  _dark" novalidate>
				<div class="row _form-content">
					...
					<div class="col-md-5 col-lg-4 formulario-banner">
						...
						<div class="_form_element _x48647240 _full_width " >
							...
							<div class="_field-wrapper form-group">
								<input  class="form-control " type="text" name="email" required placeholder="Correo electrónico *" required/>
							</div>
						</div>
